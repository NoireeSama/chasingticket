...
<div class="mb-4 flex gap-4 items-center justify-between">
    <form method="GET" action="{{ route('admin.partners.index') }}" class="flex gap-3 items-center flex-1">
        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y border-t">
                ...
                <tr class="hover:bg-slate-50/50 transition">
                    ...
                    <td class="px-8 py-6">
                        <img src="{{ $partner->url_Logo }}" alt="{{ $partner->name }}" class="w-16 h-16 object-contain rounded-xl border border-slate-100">
                    </td>
                    <td class="px-8 py-6">
                        <p class="text-sm text-slate-500">{{ $partner->created_at->format('d M Y H:i') }}</p>
                    </td>
                    <td class="px-8 py-6">
