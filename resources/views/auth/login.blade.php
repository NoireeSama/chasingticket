...
<body class="bg-indigo-900 text-white min-h-screen flex items-center justify-center p-6">
    <div class="max-w-md w-full bg-white text-slate-900 rounded-[2rem] p-8 shadow-2xl">
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-black text-indigo-950">Admin Login</h1>
        ...
        <form action="{{ route('admin.login.post') }}" method="POST" class="space-y-6">
            ...
            <button type="submit" class="w-full py-4 bg-indigo-600 text-white rounded-2xl font-black text-xl shadow-lg shadow-indigo-200 hover:bg-indigo-700 active:scale-95 transition-all">Masuk</button>
        </form>
    </div>
</body>
</html>
