...
<main class="max-w-4xl mx-auto px-4 sm:px-6 py-10 md:py-16">
    ...
    <form action="{{ route('checkout.store', $event) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin membeli tiket ini?');" class="space-y-8">
        ...
        <div class="space-y-4 pt-2">
            <button type="submit"
                class="w-full py-5 md:py-6 px-8 bg-[#103370] text-white font-black text-lg md:text-xl rounded-full min-h-[64px] shadow-[0_12px_30px_rgba(16,51,112,0.3)] hover:bg-[#F24781] hover:shadow-[0_15px_35px_rgba(242,71,129,0.4)] transition-all duration-300 transform active:scale-98 flex items-center justify-center gap-3 tracking-wide">
